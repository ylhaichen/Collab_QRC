...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("cross_robot_alignment_source", default_value="team_loop_closure"),
        DeclareLaunchArgument("swarm_agreement_mode", default_value="optional_if_available"),
        DeclareLaunchArgument("require_swarm_loop_agreement", default_value="false"),
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                "map_merge": "true",
                "cross_robot_alignment_source": LaunchConfiguration("cross_robot_alignment_source"),
                "swarm_agreement_mode": LaunchConfiguration("swarm_agreement_mode"),
